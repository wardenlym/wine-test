...
# Generally necessary
sudo apt install -y libasound2-dev:i386 libpulse-dev:i386 libdbus-1-dev:i386 libfontconfig-dev:i386 libfreetype-dev:i386 libgnutls28-dev:i386 libpng-dev:i386  libjpeg-dev:i386 libgl-dev:i386 libunwind-dev:i386 libxml2-dev:i386 libxslt1-dev:i386
